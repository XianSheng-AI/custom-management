      ...
      <!-- 搜索条件 -->
        <div class="condition">
          <div class="condition-empty">
            ...
            <div class="condition-item">
              <label for="company" value='用户信息'>用户信息 :&nbsp;</label>
              <input class="input-com"  
              name="company" 
              type="text" 
            ...
            <!-- 查询按钮 -->
            <!-- <div class="sub-btn" @click="findDataM()"><svgicon iconClass="icon-chazhao" class="do-icon-com"></svgicon>统计</div> -->
            <div class="sub-btn" @click="findDataM()"><svgicon iconClass="icon-tongji4" class="do-icon-com"></svgicon>统计</div>
          </div>
        </div>
        <!-- 按钮操作组 -->
        <div class="button-group">
          ...
          <div class="btn-com" @click="doBottom('dao')"><svgicon iconClass="icon-huabanfuben1" class="do-icon-com"></svgicon>发送邮件</div>
        </div>
  ...
  data(){
   return {
    ...
    historyData: [
      ...
      shebeiNo:'0021',
      shebeiName:'手持机',
      online_time:'2019.1.13',
      expire_time:'2020.6.18',
      connect_way:'183邮箱'
      },
      {
     customer:'天天快递',
